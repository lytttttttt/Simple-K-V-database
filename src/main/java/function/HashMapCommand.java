...
public class HashMapCommand {
    ...
    public static void open() throws IOException {   //预加载
        bufferedReader = new BufferedReader(new FileReader(".\\files\\hashmap.properties")); //获取文件读取对象
    ...
    public static void save() throws IOException { //客户端退出时保存map
        fileOutputStream = new FileOutputStream(".\\files\\hashmap.properties"); //借助FileOutputStream 写入内容
